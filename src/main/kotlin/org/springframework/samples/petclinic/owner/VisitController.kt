...
@Autowired
constructor(private val visits: VisitRepository, private val pets: PetRepository) {
    ...
    @RequestMapping(value = "/owners/*/pets/{petId}/visits/new", method = arrayOf(RequestMethod.GET))
    fun initNewVisitForm(@PathVariable("petId") petId: Int, model: Map<String, Any>): String {
        return "pets/createOrUpdateVisitForm"
    }

    // Spring MVC calls method loadPetWithVisit(...) before processNewVisitForm is called
    @RequestMapping(value = "/owners/{ownerId}/pets/{petId}/visits/new", method = arrayOf(RequestMethod.POST))
